const comments = [
  {
    ...
    content: "Я Джон Дориан мой первый коммент",
  ...
  },
  {
    ...
    pageId: "67rdca3eeb7f6fgeed471815",
    userId: "67rdca3eeb7f6fgeed471815",
    content: "Я Джон Дориан мой второй коммент",
  ...
  },
  {
    ...
    userId: "67rdca3eeb7f6fgeed471815",
    content: "Я Боб Келсо мой первый коммент",
    created_at: "1633573058520"
  }
];
...
const remove = (id) =>
  new Promise((resolve) => {
    window.setTimeout(function () {
      ...
      console.log("newComments in remove", newComments);
